...
public class SqlDatabaseSinkConnectorConfig extends AbstractConfig {
    ...
    private static final String BATCH_SIZE_DOC = "Number of data points to write at a time. Defaults to 100 (max value)";


    public SqlDatabaseSinkConnectorConfig(ConfigDef config, Map<String, String> parsedConfig) {
        super(config, parsedConfig);
    }

    public SqlDatabaseSinkConnectorConfig(Map<String, String> parsedConfig) {
